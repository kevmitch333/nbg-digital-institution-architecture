...
export function CareerRecordTabs() {
  return (
    <Tabs defaultValue="career" className="career-record-tabs">
      <TabsList className="career-tabs-list" variant="line" aria-label="Kevin Mitchell career information">
        <TabsTrigger value="career">Career record</TabsTrigger>
        <TabsTrigger value="consulting">Consulting</TabsTrigger>
      </TabsList>

      <TabsContent value="career" className="career-tab-panel">
      ...
      <TabsContent value="consulting" className="career-tab-panel consulting-panel">
        <div className="consulting-intro">
          <h3>Selected consulting clients</h3>
          <p>Engagements across music, media, technology, entertainment and institutional esports.</p>
        </div>
